...
namespace Pierre
{
  class Program
  {
    ...
    // private static List<Bread> breadCart = new List<Bread> {};
    // private static List<Pastry> pastryCart = new List<Pastry> {};
    ...
    {
      // Console.WriteLine("BreadCart " + breadCart );
      ...
      else if (goodBye == "n")
      {
        ...
        foreach (Bread loaf in breadBasket)
        {
          ...
          Console.WriteLine("Your Bread Total is: $" + grandTotal);
        }
      }
      else
      {
